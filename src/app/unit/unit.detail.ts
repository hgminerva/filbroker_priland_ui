...
export class UnitDetail {
    ...
    // private properties - subscription variables (api calls)
    private unitSub : any;
    ...
    @ViewChild("cmbHouseModel")
    public cmbHouseModel : ElementRef;
      ...
      this.unitSub = this.unitService.unitObservable
        .subscribe(
          data => {
            ...
            this.getCmbHouseModelData();
            this.getCmbUnitStatusData();
          }
        );
    }

    public getCmbHouseModelData() : void {
    ...
    public getCmbUnitStatusData() : void {
    ...
    public cmbHouseModelChange() : void {
        let index = this.cmbHouseModel["selectedIndex"];
        let houseModelId = this.cmbHouseModelData[index]["id"];
